...
/**
 * Emulación de vista por consola. Se muestra como un ejemplo de uso de la clase
 * Control.
 *
...
public class MainClass {
    ...
    public static void main(final String[] args) {
        ...
        c.agregarEntidades(
                new Object[][]{
                    {new Long(1), "Taladro", new Double(75000)}, // Agrega una Entidad Tornillo con Cantidad 1000 y precio 500
                    {new Long(2), "Taladro", new Double(0)}, // Agrega una Entidad Pinza con Cantidad 5000 y precio 10
                    {new Long(10), "Pinza", new Double(5000)}, // Agrega una Entidad Tornillo con Cantidad 1000 y precio 500
                    {new Long(100), "Tuerca", new Double(1200)}, // Agrega una Entidad Taladro con Cantidad 1 y precio 75000
